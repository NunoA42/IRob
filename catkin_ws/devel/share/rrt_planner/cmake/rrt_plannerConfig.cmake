...
if("TRUE" STREQUAL "TRUE")
  set(rrt_planner_SOURCE_PREFIX /root/catkin_ws/src/rrt_planner)
  set(rrt_planner_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(rrt_planner_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/src/rrt_planner/include " STREQUAL " ")
  set(rrt_planner_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/rrt_planner/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Joao Pinto <joao.s.pinto@tecnico.ulisboa.pt>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rrt_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/rrt_planner/${idir}'.  ${_report}")
    endif()
...
set(depends "costmap_2d;geometry_msgs;nav_msgs;tf2_geometry_msgs;tf2;nav_core;pluginlib;roscpp")
