...
namespace rrt_planner {
    ...
    class RRTPlanner {
        ...
        public:
            ...
            // /**
            //  * @brief Smooths the path by removing unnecessary intermediate nodes through shortcuts
            //  * @param path Vector of nodes representing the path to smooth (modified in-place)
            //  */
            // void smoothPath(std::vector<Node>& path);

            // /**
            //  * @brief Reduces path density by removing waypoints closer than min_distance
            //  * @param path Vector of nodes representing the path
            //  * @param min_distance Minimum distance between consecutive waypoints
            //  */
            // void decimatePath(std::vector<Node>& path, double min_distance);

            // /**
            //  * @brief Extracts path from goal back to start by following parent pointers
            //  * @return Vector of nodes from start to goal
            //  */
